...
class Model(nn.Module):
    def __init__(self):
        ...
        self.entity_feature_dim = Args.DIM_ENTITY
        self.tactic_feature_dim = Args.DIM_TACTIC
        ...
        self.tactic_mlp = MLP([self.tactic_feature_dim, 128, 64], "tactic_mlp")
        fc_lstm_and_linear_mlp = [fc_concat_dim_list[-1] + fc_concat_other_mlp_list[-1] + 64, self.dim_public]
    ...
    def forward(self, data_list, inference=False):
        ...
        entity_vec, tactic_vec = feature_vec.split(
            [self.entity_feature_dim, self.tactic_feature_dim],
            dim=1,
        )
        ...
        feature_vec_split_list = entity_vec.split(
            [
        ...
        tactic_result = self.tactic_mlp(tactic_vec)
